...
dataset_type = 'LAKEDataset_Group6'
data_root = 'data/lake/'
img_norm_cfg = dict(
...
optimizer = dict(type='SGD', lr=0.003, momentum=0.9, weight_decay=4e-05)
...
lr_config = dict(
    ...
    warmup_ratio=1e-06,
    by_epoch=False)
work_dir = './work_dirs/ganav_group6_lake'
gpu_ids = [0]
auto_resume = False
